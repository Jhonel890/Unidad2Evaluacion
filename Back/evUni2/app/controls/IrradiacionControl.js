...
class IrradiacionControl {
    ...
    async guardar(req, res) {
        const { mes, valorIrraciacion, proyecto } = req.body;
        if (mes && valorIrraciacion && proyecto) {
            try {
                ...
                const data = {
                    mes: req.body.mes,
                    valorIrraciacion: req.body.valorIrraciacion,
                    IDProyeto: proA.id
                };
...
module.exports = IrradiacionControl;
