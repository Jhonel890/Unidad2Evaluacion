...
const generador = models.generador;
const proyecto1 = models.proyecto;
...
class GeneradorControl {
    ...
    async guardar(req, res) {
        const { eficiencia, kilovatiosGenerados, proyecto } = req.body;
        if (eficiencia && kilovatiosGenerados) {
            try {
                ...
                const data = {
                    ...
                    kilovatiosGenerados: req.body.kilovatiosGenerados,
                    IDProyeto: proA.id
                };
                ...
                try {
                    const result = await generador.create(data, transaction);
...
module.exports = GeneradorControl;
